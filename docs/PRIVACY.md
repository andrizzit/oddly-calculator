# Oddly privacy policy

Effective date: September 11, 2026.

Oddly does not collect or transmit personal data. It contains no advertising, analytics, tracking, accounts, or third-party SDKs. It works without an internet connection.

Calculation history, settings, and discovered Easter eggs are saved in the app's local storage. Your device's backup services may back up this data according to your device settings. You can clear calculation history inside the app. Deleting the app removes its local data; backups are managed separately by your operating system.
